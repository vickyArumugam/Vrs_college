...
function WelcomePage() {
  ...
  const handleFileChange = (e) => {
    setBackgroundImage(e.target.files[0]); // Capture the file
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center py-12 px-6">
      ...
      <div className="w-full max-w-md p-8 rounded-lg shadow-lg bg-[#0B0A2A]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="mb-4">
            <label className="block text-white text-sm font-semibold mb-2">Conference Date</label>
            <input
              type="date"
              name="conferenceDate"
          ...
          <div className="mb-6">
            <label className="block text-white text-sm font-semibold mb-2">Background Image</label>
            <input
              type="file"
