        ...
        <div>
            ...
            <section className="bg-[#ffffff] h-auto">
                {sections.map((section) => (
                    <div className="bg-white" key={section.id}>
                        <h1 className="w-[60%] ml-[20%] text-center font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-Kaisei-Decol p-1 lg:p-0"
                         style={{ color: props.color2 }}>
                            {section.conference_name}
                        </h1>
                        <p className="w-[40%] ml-[30%] text-black text-center text-base sm:text-lg md:text-xl text-bold font-Helvetica my-10">
