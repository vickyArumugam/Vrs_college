    ...
    <AboutHeader/>
      <section className='bg-[#0B0A2A]'>
        <div className='mt-20 bg-black' >
          <h1 className='text-center font-bold text-40  text-[#C8F51E] '>
          First International Conference on Modern Research in <br />Engineering Science and Technology <br />
          (ICMREST-2018)
          </h1>
          <p className='text-center text-20 text-bold my-10'>conducted on 7th April, 2018 at V.R.S. College of Engineering and Technology, Arasur - 607 <br />107,  Villupuram District.
          </p>
        ...
        <div className='mt-20'>
          ...
          <p className='text-center text-20 text-bold my-10'>Inaugurated by Dr. Gunasekaran Manogaran, Big Data Scientist, University of California,<br /> Davis, USA, on 23rd March 2019.
          </p>
