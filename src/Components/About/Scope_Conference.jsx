...
const Scope_Conference = (props) => {
  ...
  useEffect(() => {
    fetchData('http://localhost/mailapp/about_scope_conference.php', setAboutConference, setIsLoadingAbout);
  }, []);
  ...
  return (
    <div>
      <AboutHeader title={"SCOPE OF CONFERENCE"} theme1={props.color1} theme2={props.color2}/>
